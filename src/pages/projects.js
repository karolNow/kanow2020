...
const Instalations = () => (
  <Layout>
    ...
    <div className="projects">
            <h1 className="ud-line">Projects I made or was participant</h1>
            <div className="project">
                <h1 className="project-title">USLESS MACHINES</h1>
            ...
            <div className="project">
                <h1 className="project-title">EMPATYPHYTE {'{ Empatyfit }'}</h1>
            ...
            <div className="project">
                <h1 className="project-title">STAIRSEATS</h1>
            ...
            <div className="project">
                <h1 className="project-title">WARSAW HAMMOCKS</h1>
        ...
        <div className="exibits">
            <h1 className="ud-line">Wystawy/Teksty</h1>
            <ul>
